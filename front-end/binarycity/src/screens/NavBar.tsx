            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              <li className="nav-item">
                <Link
                  ...
                  to={"/clients"}
                >
                  <i className="fab fa-facebook-square text-lg leading-lg text-white opacity-75"></i><span className="ml-2">Client List</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  ...
                  to={"/ContactScreen"}
                >
                  <i className="fab fa-twitter text-lg leading-lg text-white opacity-75"></i><span className="ml-2">Contact List</span>
                </Link>
              </li>
              <li className="nav-item">
                <a
